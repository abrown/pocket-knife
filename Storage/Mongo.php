...
class StorageMongo implements StorageInterface {
    ...
    public function __construct($settings = null) {
        ...
        BasicValidation::with($settings)
                ...
                ->upAll()
                ->withProperty('collection')->isString()
                ->upAll()
    ...
    public function create($record, $id = null) {
        if (!is_null($id))
            throw Error('MongoDB create() cannot specify an arbitrary ID', 400);
        // create
        ...
        if (!$success)
            throw new Error('CREATE action failed: no reason given', 400);
        // return
    ...
    public function update($changes, $id) {
        ...
        if (!$success)
            throw new Error('UPDATE action failed: unknown reason', 400);
        // return
        return $record;
    }
    ...
    public function delete($id) {
        ...
        if (!$success)
            throw new Error('DELETE action failed: unknown reason', 400);
        // return
        return $record;
    }
